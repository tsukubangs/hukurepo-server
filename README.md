...
## 準備
### 必要なもの
1. 80番・443番ポートを開放したサーバ（推奨アーキテクチャ:Ubuntu16.04 amd64）
1. サーバのドメイン
...
Ubuntu16.04LTS amd64のサーバを使用している場合は、インストール作業が自動化されているためそのまま「4.セットアップシェルの実行」に進んでさい。
